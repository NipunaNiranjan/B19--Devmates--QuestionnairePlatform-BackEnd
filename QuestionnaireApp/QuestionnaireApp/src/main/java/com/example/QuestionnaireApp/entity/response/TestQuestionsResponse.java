...
public class TestQuestionsResponse {
    ...
    public TestQuestionsResponse(String questionnaireName,int questionnaireDuration,String question,
                                 String answer1,String answer2,String answer3,String answer4,String correctAnswer,int id){
